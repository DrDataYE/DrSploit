...
def sem_2():
 ...
 time.sleep( 0.01)
 print (cyan+'''           /Nmmdddhhho++`     ''' +red+'DrSploit'+cyan+'''     /hdhhhhhhdm-               ''')
 time.sleep( 0.01)
...
def sem_3():
 ...
 print (cyan+'''                                     ./       .-.               '''   )                       
 time.sleep(0.01)
 print (cyan+'''                           '''+red+'DrSploit'+cyan+'''     o..   .  /- -                                     ''')
 time.sleep(0.01)
 print (cyan+'''                        `.`..-:-`    .sh+-.`:- :`:.                                        ''')
 time.sleep(0.01)
 ...
 time.sleep(0.01)
 print (cyan+'''........................ Dr Data { '''+red+'DrSploit'+cyan+''' } .............................''')         
 time.sleep(0.01)
 print (cyan+'''.....................................................................      ''')
 time.sleep(0.01)                              
def sem_4():
...
def sem_5():
 ...
 print (cyan+'            `+-             `     `.            `do.')
 time.sleep(0.01)
 print (cyan+'              ```       '+green+'DrData'+cyan+'{'+red+'DrSploit'+cyan+'}         `.`')
 time.sleep(0.01)
 print (cyan+'                 ````                      ````')
 time.sleep(0.01)
...
def sem_6():
 ...
 print (cyan+"                /~                             ~\ ")
 time.sleep(0.01)
 print (cyan+'              .~             '+green+'DrSploit'+cyan+'             ~')
 time.sleep(0.01)
...
def sem_8():
 ...
 print (cyan +'         !!                                           !! \ ')
 time.sleep(0.01)          
 print (cyan +'         !!           Welcome to { '+red+'DrSploit'+cyan+' }           !!  \ ')
 time.sleep(0.01)         
 print (cyan +'         !!                                           !!  ! ')
 time.sleep(0.01)
 print (cyan +'         !!                                           !!  ! ')
